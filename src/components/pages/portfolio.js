    ...
    <Transition in={inProp} timeout={duration}>
        {(state) => (
            <div style={{
                ...
                <div className="col-md-3 boom portfolio-images-holder b1"> <img src="http://themes.themewaves.com/tweeco/wp-content/uploads/sites/31/2015/08/portfolio-7-380x300.jpg"/></div>
                <div className="col-md-3 boom portfolio-images-holder b2"> <img src="http://themes.themewaves.com/tweeco/wp-content/uploads/sites/31/2015/08/portfolio-7-380x300.jpg"/></div>
                <div className="col-md-3 boom portfolio-images-holder b3"> <img src="http://themes.themewaves.com/tweeco/wp-content/uploads/sites/31/2015/08/portfolio-7-380x300.jpg"/></div>
                <div className="col-md-3 boom portfolio-images-holder b4"> <img src="http://verk.premiumcoding.com/wp-content/uploads/2012/04/verk-portfolio-image-4-380x300.jpg"/></div>
    ...
    return (
      ...
      <div className="row">
          <div id= "sortGallery" className="btn-group btn-group-justified groupedLinks">
                <a id="ux" href="#" className="btn btn-primary one first"  onClick={() => this.handleToggle(1)}>UX/UI</a>
                <a id="Photograph" href="#" className="btn btn-primary one" onClick={() => this.handleToggle(2)}>Photograph</a>
          ...
          <div id="imageMainDiv" className="galleryMainHolder col-lg-12"><Fade in={!!show} />
